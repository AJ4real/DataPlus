...
public class NMSImpl implements NMS {
    ...
    private NBTBase convert(NBTTag object) {
        ...
        if(object instanceof NBTCompoundTag) {
            ...
            net.minecraft.server.v1_15_R1.NBTTagCompound ret = new net.minecraft.server.v1_15_R1.NBTTagCompound();
    ...
    public ItemStack getItem(NBTCompoundTag nbt) {
        return CraftItemStack.asBukkitCopy(net.minecraft.server.v1_15_R1.ItemStack.a((NBTTagCompound) convert(nbt)));
    }
