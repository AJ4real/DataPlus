...
package me.aj4real.justanothernbtapi.nms.v1_16_R3;
...
public class NMSImpl implements NMS {
    ...
    public ItemStack getItem(NBTCompoundTag nbt) {
        return CraftItemStack.asBukkitCopy(net.minecraft.server.v1_16_R3.ItemStack.a((NBTTagCompound) convert(nbt)));
    }
